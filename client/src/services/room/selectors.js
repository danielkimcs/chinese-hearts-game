export const getRoomDisplayStatus = store => store.room.displayStatus;

export const getRoomPlayers = store => store.room.players;

export const getRoomState = store => store.room.roomState;
